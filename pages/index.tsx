  ...
  return (
    <>
      ...
      <main className={styles.main}>
        ...
        <BarChart ageCaseInfoState={ageCaseInfoState} ageBackGroundColor={ageBackGroundColor}/>
        <PieChart ageCaseInfoState={ageCaseInfoState} ageBackGroundColor={ageBackGroundColor}/>
      </main>
    </>
  )
}
